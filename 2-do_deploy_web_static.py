...
def do_deploy(archive_path):
    ...
    run("sudo tar -xzf /tmp/" no_extension + ".tgz" +
        " -C /data/web_static/releases/" + no_extension  + "/")
    run("sudo rm /tmp/" + no_extension + ".tgz")
    run("sudo mv /data/web_static/releases/" + no_extension +
        "/web_static/* /data/web_static/releases/" + no_extension + "/")
    run("sudo rm -rf /data/web_static/releases/" +
        no_extension + "/web_static")
    run("sudo rm -rf /data/web_static/current")
    run("sudo ln -s /data/web_static/releases/" + no_extension +
